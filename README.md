...
```bash
cd /Users/izzy/Documents/izzy-blog-cowork
...
```bash
claude plugin marketplace add promptmetrics/izzy-blog-cowork
claude plugin install izzy-blog-cowork@promptmetrics
```
...
1. `claude plugin validate ./` should pass.
